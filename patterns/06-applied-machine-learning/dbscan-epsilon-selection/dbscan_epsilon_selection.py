...
# Source:  Ismael-Sallami/machine-learning-practices -> src/practice-2-unsupervised-learning.ipynb (notebook cells defining calcular_epsilon_optimo, justificar_epsilon_por_silueta)
