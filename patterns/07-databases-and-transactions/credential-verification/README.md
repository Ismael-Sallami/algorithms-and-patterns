...
[`oracle-dbms-project/src/usuarios/auth.py`](https://github.com/Ismael-Sallami/oracle-dbms-project/blob/main/src/usuarios/auth.py#L1-L26) &mdash; complete file.
