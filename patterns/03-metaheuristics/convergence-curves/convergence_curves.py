...
# Source:  Ismael-Sallami/MH-Practices -> practice-3/EXTRA/convergencia_comparativa.py (complete file)
#          https://github.com/Ismael-Sallami/MH-Practices/blob/main/practice-3/EXTRA/convergencia_comparativa.py#L1
