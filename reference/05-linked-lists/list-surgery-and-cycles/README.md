# List surgery and cycles

## Idea

Pointer surgery written out rather than hidden behind a container, plus the cycle detection that a linked structure needs.
...
```
g++ -std=c++20 -O1 -Wall -o /tmp/check list_surgery_and_cycles.cpp && /tmp/check
```
